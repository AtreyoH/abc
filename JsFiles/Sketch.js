...
function setup() {
  ...
  startImgSprite = createSprite(displayWidth / 2, displayHeight / 2, windowWidth, windowHeight)  //introductory img in gamestate 0
  startImgSprite.addImage("start", startImg)      //adding the img loaded in function preload
  startImgSprite.scale = 0.3    //making the img bigger
  startImgSprite.visible = false  //making the img invisible
  //startImgSprite.imageMode(CENTER)
  ...
  classObject()
  spaceCraft = createSprite(-5000, displayHeight / 2-170, 10, 10) //main sprite in the game
  spaceCraft.addImage("spaceCraft", spaceCraftImg)
  spaceCraft.visible = false
  spaceCraft.scale = 0.65
  // obstacleSprites()
